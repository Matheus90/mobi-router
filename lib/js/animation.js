...
jQuery.fn.hardwareAnimateAbs = function(endProperties, duration, easing, callback) {
    var element = this[0],
    ...
    var transformString = function(percentComplete, isComplete) {
        ...
        for(prop in endProperties) {
            if(prop != 'translateZ') {
                ...
                var value = element.startProperties[prop] + (percentComplete*(endProperties[prop] - element.startProperties[prop]));
