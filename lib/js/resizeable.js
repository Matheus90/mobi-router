        ...
        elements: {
            ...
            resizeTitle: function(){
                ...
                var sbToggle = document.getElementById('mobi_sidebar_toggle').offsetWidth,
                    ...
                    pageTitlePadding =  parseInt(pageTitle.paddingLeft, 10) +
                                        parseInt(pageTitle.paddingRight, 10) +
                                        parseInt(pageTitle.marginLeft, 10) +
                                        parseInt(pageTitle.marginRight, 10) +
                                        parseInt(pageTitle.borderLeft, 10) +
                                        parseInt(pageTitle.borderRight, 10),
                ...
                _.each(document.getElementsByClassName('header_btn'), function(button){
                    var computed = window.getComputedStyle(button),
                        btnWidth = computed ?
                            ...
                            parseInt(computed.borderLeft, 10) +
                            parseInt(computed.borderRight, 10) + 2
                            : 0;
