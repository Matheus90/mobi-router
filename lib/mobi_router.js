(function($) {
    MRouter = function(){
        ...
        function _refreshUrl(){
            ...
            var title = this.settings.defaultTitle +' - '+this.getPageTitle();
        ...
        /**
         * Creates a new _sequence. Used in MobiRouter.go when pushToStack is false
         * If 'sequence' is given, it's used as _sequence, single item _sequence with 'route' is created otherwise
         * @param route
         * @param sequence
         */
        ...
        /**
         * Remove all routes after 'pos' from _sequence
         *
         * @param pos
         */
        ...
        /**
         * Developer can change the text of "Next" button by setting the "nextBtnText" parameter of the page
         *
         * @returns {string|"Next"}
         */
        ...
        /**
         * Developer can provide function to execute when user click 'backbtn'
         * Defaults to this.back()
         *
         * @param e
         * @returns {*}
         */
        ...
        /**
         * Works same as this.backBtnAction but for nextBtn
         * Defaults to this.next()
         * @param {event} e
         * @returns {*}
         */
        ...
        /**
         * An array full of the current sequence's route objects
         *
