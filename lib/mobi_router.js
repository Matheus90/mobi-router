    ...
    MRouter = function(){
        ...
        function _init(){
            ...
            Meteor.startup(function(){
                ...
                if( routes.length && routes[routes.length-1] && _.isFunction(routes[routes.length-1].before) )
                    routes[routes.length-1].before();
        ...
        function _addToSequence(route, data){
            ...
            if( oldLength == newLength )
                this.animateScroller(false, false, true);
        };
         ...
         */
        this.animateScroller = function(pos, time, afterAnimate){
        ...
        this.hasNextBtn = function(){
            ...
            return route.buttons != undefined && route.buttons.showNextButton != undefined ? Boolean(route.buttons.showNextButton) : Boolean( pos < _nextSequence.length-1 );
        };
