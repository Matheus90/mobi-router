    ...
    MRouter = function(){
        ...
        this.animateScroller = function(pos, time){
            ...
            var move = -(pos * this.sizes.content.width),
                time = _.isNumber(time) ? time : this.settings.scrollTime;

            this.speak('animating pages slider: to '+move+'px in '+time+' msec');
            if(_.isNumber(move) && _.isNumber(time) && document.getElementById('sequence_scroller') ) $('#sequence_scroller').hardwareAnimate({translateX: move}, time, 'easeInOutBack');
        ...
        this.showSidebar = function(){
            ...
            $('#mobi_main').hardwareAnimate({translateX: (this.sizes.sidebar.width - 5)}, 300, 'easeOutExpo', function(){
                refreshIscrolls();
        ...
        this.hideSidebar = function(){
            ...
            $('#mobi_main').hardwareAnimate({translateX: 0}, 300, 'easeOutExpo', function(){
                refreshIscrolls();
