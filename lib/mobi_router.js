    ...
    MRouter = function(){
        ...
        this.refreshSidebarScroll = function(){
            ...
            if( _sidebarIScroll ){
                ...
                //document.getElementById('mobi_sidebar').style.display = 'block';
                Meteor.setTimeout(function(){
                    if( !_sidebarIScroll ){
                        _sidebarIScroll = newScroll('mobi_sidebar', {vScroll: true});
                        clog('create sidebar scroll');
                    }
                }, 50);
        ...
        function _startNewSequence(route, sequence, runAnyway){
            ...
            if(sequence){
                ...
                this.animateScroller(_routesToDisplay.call(_this).length-1, false, true, function(animated){
                    ...
                    Meteor.setTimeout(function(){ _animationRunning = false; !animated ? MobiRouter.settings.animationT : 0});
                });
            }
        };
