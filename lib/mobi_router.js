(function($) {
    MRouter = function(){
        ...
        this.go = function(routeName, data, pushToSequence){
            ...
            if( pushToSequence === true || data === true )
        ...
        this.content = function(route){
            ...
            if( !route ) return this.settings.notFoundTemplate ? Template[this.settings.notFoundTemplate] : Template.mobi_not_found;

            if( route.type == 'tableview' ){
                console.log('template', Template);
                return Template['mobi_tableview'];
            }else{
    ...
    $(document).ready(function(){
        Deps.afterFlush(function(){
            //console.log('DOCUMENT READY MOTHERFUCKAAAAA');
