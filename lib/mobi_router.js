(function($) {
    MRouter = function(){
        ...
        this.animateScroller = function(pos, time){
            ...
            if(_.isNumber(move) && _.isNumber(time) && document.getElementById('sequence_scroller') ) $('#sequence_scroller').hardwareAnimate({translateX: move}, time, this.settings.pageMoveEasing);
        ...
        this.hasNextBtn = function(){
            ...
            console.log('showNextBtn:', route.buttons);
            return route.buttons != undefined && route.buttons.showNextButton != undefined ? Boolean(route.buttons.showNextButton) : Boolean( pos < _sequence.length-1 );
        };
        ...
        this.back = function(posToMove, keepFollowings){
            ...
            var newSequence = _removeRouteAfter.call(_.clone(_sequence), newPosition);

            if( keepFollowings == false ) Meteor.setTimeout(function(){ _sequence = _removeRouteAfter.call(_sequence, newPosition); }, this.settings.pageMoveTime );
            _setPosition.call(this, newPosition, this.settings.pageMoveTime+100);
            _refreshUrl.call(this, newSequence);
