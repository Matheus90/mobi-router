(function($) {
    MRouter = function(){
        ...
        function _setPosition(pos, triggerChangeTime){
            ...
            Meteor.setTimeout(function(){ MobiRouter.dep.changed(); }, triggerChangeTime);
        };
        ...
        function _preloadRoutes(route){
            console.log('preloadRoutes: ', route);
            var routesToPreload = route.routesToPreload || {},
                _this = this,
                sequence = _.clone(_sequence);

            sequence = _removePreloadedRoutes.call(this, {}, false);

            console.log('preloadRoutes: ', _.clone(sequence));
            ...
            console.log('preloadRoutes: ', _.extend(routesToPreload, preload));
            var len = sequence.length;
            _.each(_.extend(routesToPreload, preload), function(r, id){
        ...
        function _isPreloaded(route){
            var preloaded = false;
            _.each(_sequence, function(s){
                if( Boolean(s.preloaded) && s.name == route.name ) preloaded = true;
            });
            console.log('Route preloaded: ', preloaded, route, _.clone(_sequence) );
            return preloaded;
        }
        ...
        this.configure = function(settings){
            ...
            if( this.settings.useTouchEvents ) ClickBuster.init();
        ...
        this.go = function(routeName, params, pushToStack){
            ...
            if( !r ){ _goingSomewhere = false; return console.log('Error: This route does not exists.'); }
        ...
        function _startNewSequence(route, sequence){
            ...
            console.log("startNewSeq: ", _sequence);
            ...
            _setPosition.call(this, _routesToDisplay.call(this).length-1, 50);
            if(sequence){
                this.jumpToPosition();
                _preloadRoutes.call(this, route);
            }else
                this.animateScroller(false, false, true, function(){
        ...
        this.content = function(route){
            ...
            if( !route )
                ...
                if( viewTemplate ){
                    //console.log(Template[viewTemplate]);
        ...
        this.back = function(posToMove, keepFollowings){
            ...
            if( keepFollowings == false )
                Meteor.setTimeout(function(){ _sequence = _removeRouteAfter.call(_sequence, newPosition); }, this.settings.pageMoveTime+50);
            ...
            this.animateScroller(false, false, false, function(){
                    Meteor.setTimeout(function(){
                        var route = _nextSequence.length ? _.last(_nextRoutesToDisplay.call(_this)) : {};
                        _preloadRoutes.call(_this, route);
                    }, (keepFollowings == false ? 150 : 0));
            });
        };
        ...
        this.first = function(keepFollowings){
            ...
            if( keepFollowings == false ) Meteor.setTimeout(function(){ _sequence = _removeRouteAfter.call(_sequence, 0); }, this.settings.pageMoveTime );
        ...
        this.last = function(){
            _refreshUrl.call(this);
            _setPosition.call(this, this.getSlideStackSize()-1);
            this.animateScroller();
        };
