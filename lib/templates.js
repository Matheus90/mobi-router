(function($){
    ...
    Template.mobi_header.events({
        'click #mobi_sidebar_toggle, touchend #mobi_sidebar_toggle': function(e){
            if(!MobiRouter.sidebarShown) MobiRouter.showSidebar();
            else MobiRouter.hideSidebar();
        },
        'click #header_back_btn, touchend #header_back_btn': function(e){
            MobiRouter.backBtnAction(e);
        },
        'click #header_done_btn, touchend #header_done_btn': function(e){
    ...
    Template.mobi_alert_button.events({
        'click .mobi_alert_button, touchend .mobi_alert_button': function(){
