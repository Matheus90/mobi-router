(function(){
    ...
    Template.mobi_router.isFooter = function(){ MobiResizeable.resizeAllElements(); return Boolean(MobiRouter.settings.footer); };
    Template.mobi_router.mobileClass = function(){ MobiRouter.dep.depend(); return isMobile || MobiRouter.showFullScreen ? 'mobile-display' : '' };
    ...
    Template.mobi_page_content.pageData = function(){
        var data = this.getData(this.getPath());
        console.log('pageData', data, this);
        data._r = this;
        return data;
    };
